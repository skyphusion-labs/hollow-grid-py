"""Browser xterm play client HTML (TS parity: the-hollow-grid src/webclient.ts)."""

from __future__ import annotations

import html

_PLAY_PAGE_TEMPLATE = r"""<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8" />
...
<div id="wrap">
  <header>
    <span>__TITLE__ <span class="net">:: the hollow grid network</span> <a class="net policies" href="https://github.com/skyphusion-labs/the-hollow-grid/tree/main/docs/legal" target="_blank" rel="noopener">policies</a></span>
...
def play_page(world_name: str) -> str:
    title = world_name or "The Hollow Grid"
    safe = html.escape(title, quote=True)
    return _PLAY_PAGE_TEMPLATE.replace("__TITLE__", safe)
